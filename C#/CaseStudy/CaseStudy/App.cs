...
namespace CaseStudy
{
    ...
    class App
    {
        ...
        {
            Student student = new Student(101, "sayli", "12/5/2000");
            Student student1 = new Student(102, "Prerna", "21/3/1999");
        ...
        public void Scenerio2()
        {
            ...
            students[0] = new Student(1010, "Akash", "12/4/1998");
            students[1] = new Student(1011, "Yogesh", "21/4/1998");
        ...
        static void Main(string[] args)
        {
            ...
            /* Student student1 = new Student(001, "Anuja", "1/05/1998");
             Student student2 = new Student(002, "Sakshi", "2/06/1999");
             Student student3 = new Student(003, "Pooja", "3/07/2000");

             Course course1 = new Course(101, "Full stack web devlopment", 90, 25000.00f);
             Course course2 = new Course(102, "hacking", 60, 20000.00f);
             Course course3 = new Course(103, ""software testing, 30000.00f);
            */
